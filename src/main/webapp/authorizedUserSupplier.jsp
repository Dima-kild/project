...
<br>
<p style="max-width: 700px; margin: 0 auto" class="fig"><img src="foto/42343.png"
                                                             width="700" height="350" alt="Фотография"></p>
<br>
<div class="login-block" style="max-width: 600px; margin: 0 auto">
    <table style="with: 50%">
        <h1 >Вы зашли как поставшик товаров</h1>

        <br><br>
        <div class="btn-group" role="group" aria-label="Basic outlined example">
            <a href="/GetAllItemsForSupplier" type="button" class="btn btn-outline-primary">Все заказы</a>
            <a href="/logout" type="button" class="btn btn-outline-primary">Выйти</a></div>
    </table>
</div>
